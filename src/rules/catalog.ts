...
const CONFIGURATION_RULES: readonly CoreRuleDefinition[] = [
  {
    ...
    testContract: "test/config.test.ts",
  },
  {
    ruleId: "LR002",
    checkId: "config.network-safety",
    domain: "configuration",
  ...
  },
  {
    ...
    resultKind: "validation-issue",
    implementation: "src/config/load.ts#validateConfigPaths",
    testContract: "test/config.test.ts",
  },
];
