  ...
  assert.deepEqual(manifest.cases[0], {
    ...
    expectations: {
      broken: {
        ...
        flowSha256: "d64cd86713348caf96cc1e5740abc046b47cbdabcd05f48f1a799257779d4cb5",
        scenarioStatus: "fail",
        outcome: "failed",
        exitCode: 1,
      },
      fixed: {
        ...
        flowSha256: "51c86ab76aa0a5c423997311c1a1517687ddc68db6e24f9334f1fb35a90c4d15",
        scenarioStatus: "pass",
        outcome: "passed",
        exitCode: 0,
      },
